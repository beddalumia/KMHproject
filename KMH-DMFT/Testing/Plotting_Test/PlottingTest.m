...
for iSOI = 1:Nlines
    ...
    Sct = scatter(ax,SOI,U,30,'filled','MarkerFaceAlpha',1); hold on
    Plt = plot3(ax,SOI,U,z2,'LineWidth',2); hold on
    cd('..');
end
% Plot transition line
plot3(transLine(1,:),transLine(2,:),min(z2)*ones(2,Nlines),'r','LineWidth',2.5);
