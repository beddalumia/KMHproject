...
#SBATCH --mail-user=gbellomia@live.it       # Where to send the mail
#
...
#
#matlab -batch RunningDMFT_dry	#-----------------
#matlab -batch RunningDMFT_autostop	# Uncomment just
#matlab -batch RunningDMFT_autoupdate	# one of these...
#matlab -batch RunningDMFT_livemixing	#-----------------
#
#
# ==== END OF JOB COMMANDS ===== #
#
